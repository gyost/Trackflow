...
export default function GuideModal({ onClose, content }: GuideModalProps) {
  return (
    <div className="fixed inset-0 bg-black/60 z-50 flex flex-col justify-end sm:justify-start items-center sm:pt-20 overflow-y-auto">
      <div className="bg-white max-w-2xl w-full sm:mx-4 mt-auto sm:mt-0 sm:mb-20 pt-8 sm:pt-8 p-6 sm:p-8 sm:border border-[#1A1A1A] sm:shadow-[8px_8px_0px_#1A1A1A] relative selection:bg-[#1A1A1A] selection:text-white rounded-t-2xl sm:rounded-none">
